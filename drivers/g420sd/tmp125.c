...
static int __init tmp125_init(void)
{
	...
	if (ret) {
		...
		printk("BSP: g420sd TMP125 Driver installed\n");
	}
...
static void __exit tmp125_exit(void)
{
	...
	printk("BSP: g420sd TMP125 Driver removed\n");
}
...
MODULE_DESCRIPTION("g420sd TMP125 temperature driver");
MODULE_LICENSE("GPL");
