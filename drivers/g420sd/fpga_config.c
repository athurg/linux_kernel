...
{
	__raw_writeb(0x0, FPGA_CFG_CLK_BASE);
}
...
static int __init fpga_cfg_init(void)
{
	...
	if (ret)
		...
		printk("BSP: g420sd FPGA_CFG Driver installed\n");
...
static void __exit fpga_cfg_exit(void)
{
	...
	printk("BSP: g420sd FPGA_CFG Driver removed\n");
}
...
MODULE_DESCRIPTION("g420sd FPGA_CFG");
MODULE_LICENSE("GPL");
