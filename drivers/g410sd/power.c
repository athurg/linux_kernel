...
static int __init power_init(void)
{
	...
	power_st.dev.name = "g410sd_power";
	...
	printk("BSP: G410SD Power Driver installed\n");
	return 0;
...
fail_registe:
	printk("BSP: Fail to install G410SD Power driver\n");
	return ret;
}
...
MODULE_DESCRIPTION("G410SD POWER");
MODULE_LICENSE("GPL");
