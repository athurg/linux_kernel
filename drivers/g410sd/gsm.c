...
static int __init gsm_init(void)
{
	...
	gsm_st.dev.name = "g410sd_gsm_config";
	...
	if (ret) {
		...
		__raw_writel(GSM_VCHARGE, GPIO_P3_OUTP_CLR(GPIO_IOBASE));
		printk("BSP: G410SD GSM Driver installed\n");
	}
...
static void __exit gsm_exit(void)
{
	...
	printk("BSP: G410SD GSM Driver removed\n");
}
...
MODULE_DESCRIPTION("G410SD GSM control");
MODULE_LICENSE("GPL");
