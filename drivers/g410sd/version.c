...
static int __init version_init(void)
{
	...
	version_st.dev.name = "g410sd_version";
	...
	if (ret)
		...
		printk("BSP: G410SD Version Driver installed\n");
...
static void __exit version_exit(void)
{
	...
	printk("BSP: 200WO Version Driver removed\n");
}
...
MODULE_DESCRIPTION("G410SD VERSION");
MODULE_LICENSE("GPL");
