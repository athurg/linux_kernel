...
static int __init if_fpga_init(void)
{
	...
	if_fpga_st.dev.name = "g410sd_if_fpga";
	...
	printk("BSP: G410SD IF_FPGA Driver installed!\n");
...
fail_malloc:
	printk("BSP: Fail to install G410SD IF_FPGA driver\n");
...
static void __exit if_fpga_exit(void)
{
	...
	printk("BSP: G410SD IF_FPGA Driver removed\n");
}
...
MODULE_DESCRIPTION("G410SD IF_FPGA");
MODULE_LICENSE("GPL");
