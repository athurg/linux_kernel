...
#define CMD_SET_LMK03000_GOE		_IOW(G200WO_IOCTL_MAGIC, 0x03, int)

#define CMD_GET_LMK03000_LD		_IOR(G200WO_IOCTL_MAGIC, 0x01, int)

#define ARGS_LMK03000_SYNC_ON	0
#define ARGS_LMK03000_SYNC_OFF	1
