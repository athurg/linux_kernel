...
#define CMD_IF_FPGA_READ_WORD		_IOR(G410SD_IOCTL_MAGIC, 0x01, int)
#define CMD_IF_FPGA_WRITE_WORD		_IOW(G410SD_IOCTL_MAGIC, 0x01, int)
#define CMD_IF_SET_PID			_IOW(G410SD_IOCTL_MAGIC, 0x02, int)
