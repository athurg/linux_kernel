...
// command of ioctrl
#define CMD_GSM_PWR	_IOW(G410SD_IOCTL_MAGIC, 0x01, int)
#define CMD_GSM_VCHARGE	_IOW(G410SD_IOCTL_MAGIC, 0x02, int)
#define CMD_GSM_ATT	_IOW(G410SD_IOCTL_MAGIC, 0x03, int)
